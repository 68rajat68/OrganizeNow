...
function NavBar() {
    ...
    return (
        ...
        //             {/* Sidebar toggle button on the extreme left */}
        //             <button
        ...
        //                     <i
        //                         className="fa-solid fa-boxes"
        //                         style={{ marginRight: '5px', color: '#E0FFFF' }}
        //                     ></i>
        //                     OrganizeNow
        //                 </span>
        //             </NavLink>
        ...
        //             }}
        //         >
        //             <div className="menu_header d-flex justify-content-between align-items-center">
        //                 {/* Close button in the right corner of the sidebar */}
        //                 <div
        //                     className="close-btn"
        ...
        //             >
        //                 <i
        //                     className="fa-solid fa-clipboard-list mx-1"
        //                     style={{ color: 'white' }}
        //                 ></i>
        //                 iNotebook
        //             </NavLink>
        //             <NavLink
        //                 className={`nav-link ${activeTab === '/Schedulr' ? 'active' : ''}`}
        //                 to="/Schedulr"
        //                 onClick={() => {
        //                     setMenuOpen(false);
        //                     setActiveTab('/Schedulr');
        //                 }}
        //             >
        //                 <i
        //                     className="fa-solid fa-calendar-alt mx-1"
        //                     style={{ color: 'white' }}
        //                 ></i>
        //                 Schedulr
        //             </NavLink>
        ...
        //             >
        //                 <i
        //                     className="fa-solid fa-info-circle mx-1"
        //                     style={{ color: 'white' }}
        //                 ></i>
        //                 About
        //             </NavLink>
        ...
        //         {/* Desktop Navbar */}
        //         <div
        //             className={`collapse navbar-collapse ${menuOpen ? 'd-none' : ''}`}
        ...
        //                 </li>
        //                 <li className="nav-item">
        //                     <NavLink className="nav-link" aria-current="page" to="/Schedulr">
        //                         Schedulr
        //                     </NavLink>
        //                 </li>
        //                 <li className="nav-item">
        ...
        //                         Login
        //                     </NavLink>
        //                     <NavLink className="btn btn-primary mx-1" to="/signup" role="button">
        //                         SignUp
        //                     </NavLink>
        //                 </form>
        //             ) : (
        ...
        //                 <div className="profile-details">
        //                     <h4>
        //                         <i className="fa-solid fa-user" /> User Profile
        //                     </h4>
        //                     <hr />
        //                     <p>
